# -*- coding: utf-8 -*-
"""
Created on Thu Jul 26 11:55:38 2018
...
def loadnlr(filename):
    hdu = fits.open(filename)
    (Hb1_nlr_br_data,Hb2_nlr_br_data) = (hdu[1].data,hdu[4].data)
    return Hb1_nlr_br_data,Hb2_nlr_br_data
...
def Hb_O3_gauss_recons(wave,amp_Hb,amp_OIII5007,vel,vel_sigma):
...
def Hb_Fe_doublet_gauss_recons(wave,amp_Hb,amp_Fe5018,vel,vel_sigma):
    Hb = gauss_recons(wave,amp_Hb,vel,vel_sigma,4861.33)
...
def Fe_doublet_gauss_recons(wave,amp_Fe4923,amp_Fe5018,vel,vel_sigma):
    Fe_4923 = gauss_recons(wave,amp_Fe4923,vel,vel_sigma,4923)
    Fe_5018 = gauss_recons(wave,amp_Fe5018,vel,vel_sigma,5018)
    return Fe_4923+Fe_5018
...
def complex_gauss(p,wave,data,error):
    (amp_Ha_core,amp_NII6583_core,amp_SII6716_core,amp_SII6731_core,vel_core,vel_sigma_core,amp_Ha_wing,amp_NII6583_wing,amp_SII6716_wing,amp_SII6731_wing,vel_wing,vel_sigma_wing,amp_Ha_blr1,vel_blr1,vel_sigma_blr1,amp_Ha_blr2,vel_blr2,vel_sigma_blr2,m,c)=p
    nlr_core = nlr_gauss(wave,amp_Ha_core,amp_NII6583_core,amp_SII6716_core,amp_SII6731_core,vel_core,vel_sigma_core)
    ...
    return (nlr_core+nlr_wing+blr1+blr2+cont-data)/error


def full_gauss2(p,wave,data,error):
    (amp_Hb_1,amp_OIII50071,vel_OIII1,vel_sigma_OIII1,amp_Hb_2,amp_OIII50072,vel_OIII2,vel_sigma_OIII2,amp_Hb_br,amp_OIII5007_br,vel_OIII_br,vel_sigma_OIII_br,amp_Hb1,amp_Fe5018_1,vel_Hb1,vel_sigma_Hb1,amp_Hb2,amp_Fe5018_2,vel_Hb2,vel_sigma_Hb2,m,c)=p
    narrow_OIII1 = Hb_O3_gauss(wave,amp_Hb_1,amp_OIII50071,vel_OIII1,vel_sigma_OIII1)
    narrow_OIII2 = Hb_O3_gauss(wave,amp_Hb_2,amp_OIII50072,vel_OIII2,vel_sigma_OIII2)
...
# =============================================================================
# def full_gauss2_wo(p,wave,data,error):
#     (amp_Hb,amp_OIII5007,vel_OIII,vel_sigma_OIII,amp_Hb_br,amp_OIII5007_br,vel_OIII_br,vel_sigma_OIII_br,amp_Hb1,amp_Fe5018_1,vel_Hb1,vel_sigma_Hb1,amp_Hb2,amp_Fe5018_2,vel_Hb2,vel_sigma_Hb2)=p
#     narrow_OIII = Hb_O3_gauss_recons(wave,amp_Hb,amp_OIII5007,vel_OIII,vel_sigma_OIII)
#     broad_OIII = Hb_O3_gauss_recons(wave,amp_Hb_br,amp_OIII5007_br,vel_OIII_br,vel_sigma_OIII_br)
#     Hb_broad1 = Hb_Fe_doublet_gauss_recons(wave,amp_Hb1,amp_Fe5018_1,vel_Hb1,vel_sigma_Hb1) 
#     Hb_broad2 = Hb_Fe_doublet_gauss_recons(wave,amp_Hb2,amp_Fe5018_2,vel_Hb2,vel_sigma_Hb2) 
#     return (narrow_OIII+broad_OIII+Hb_broad1+Hb_broad2-data)/error
# 
# =============================================================================
...
def full_gauss2_fixkin(p,wave,data,error,fixed_param):
    (amp_Hb_1,amp_OIII50071,amp_Hb_2,amp_OIII50072,amp_OIII5007_br,amp_Hb_br,amp_Hb1,amp_Hb2,amp_Fe5018_1,amp_Fe5018_2,m,c) = p 
    [vel_OIII1,vel_sigma_OIII1,vel_OIII2,vel_sigma_OIII2,vel_OIII_br,vel_sigma_OIII_br,vel_Hb1,vel_sigma_Hb1,vel_Hb2,vel_sigma_Hb2] = fixed_param 
    narrow_OIII1 = Hb_O3_gauss(wave,amp_Hb_1,amp_OIII50071,vel_OIII1,vel_sigma_OIII1)
    narrow_OIII2 = Hb_O3_gauss(wave,amp_Hb_2,amp_OIII50072,vel_OIII2,vel_sigma_OIII2)
    broad_OIII = Hb_O3_gauss(wave,amp_Hb_br,amp_OIII5007_br,vel_OIII_br,vel_sigma_OIII_br)
    Hb_broad1 = Hb_Fe_doublet_gauss(wave,amp_Hb1,amp_Fe5018_1,vel_Hb1,vel_sigma_Hb1) 
...
def par(obj):
    hdu = fits.open('%s_central_fit2.fits'%(obj))
    central_tab = hdu[1].data
    central_columns = hdu[1].header
